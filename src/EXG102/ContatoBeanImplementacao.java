...
public class ContatoBeanImplementacao {
	...
	public static void main(String[] args) {
		...
		Contato pegaContatoPorEmail = contatoBean.pegaContatoPorEmail("jonas1@mal.com");
		...
		Contato pegaContatoPorTelefone = contatoBean.pegaContatoPorTelefone("99999992");
		if (pegaContatoPorTelefone != null) {
			...
			System.out.println("telefone: " + pegaContatoPorTelefone.getTelefone());
		}
